...
**As of 07.01.2021 Scripting is free for all users, it is very recommended you scroll down to Zynj's github, check out EWIJSON and learn how to use it. Loading WI through these scripts alone makes it work more like it should.** This document will focus on scripting-free methods. Scripting focused documents are included in the docs folder.
